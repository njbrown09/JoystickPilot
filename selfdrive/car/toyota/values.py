...
class SteerLimitParams:
  STEER_MAX = 150000
  STEER_DELTA_UP = 1     # 1.5s time to peak torque
  STEER_DELTA_DOWN = 1     # always lower than 45 otherwise the Rav4 faults (Prius seems ok with 50)
  STEER_ERROR_MAX = 35000     # max delta between torque cmd and torque motor
